...
{capture name="languages_menu"}
    {if !"ULTIMATE:FREE"|fn_allowed_for}
        {if $menu_languages|sizeof > 1}
            {include file="common/select_object.tpl" style="dropdown" link_tpl=$config.current_url|fn_link_attach:"sl=" items=$menu_languages selected_id=$smarty.const.CART_LANGUAGE display_icons=true key_name="name" key_selected="lang_code" class="languages" is_submenu=!$show_languages_in_header_menu}
        {/if}
    {/if}
{/capture}
...
{capture name="currencies_menu"}
    ...
    {/if}
{/capture}
    <div class="navbar-admin-top {if $enable_sticky_scroll}cm-sticky-scroll{/if}"
         data-ca-stick-on-screens="sm-large,md,md-large,lg,uhd" data-ca-top="{$sticky_top}"
         data-ca-padding="{$sticky_padding}">
        <!--Navbar-->
                ...
                {if "ULTIMATE"|fn_allowed_for}
                    ...
                    <div class="nav-ult">
                        ...
                        {if $runtime.company_id || $runtime.forced_company_id}
                            <ul class="nav">
                                <li class="dropdown">
                                    <a href="{"companies.update?company_id=`$runtime.company_data.company_id`"|fn_url}">{__("storefront")}
                                        : {$runtime.company_data.company}</a>
                                </li>
                            </ul>
                        {/if}
                    </div>
                        ...
                        <ul class="nav">
                            <li class="nav-company">
                                ...
                                {else}
                                    ...
                                    {/if}
                                {/if}
                                <a href="{$storefront_url}" target="_blank" class="brand"
                                   title="{__("view_storefront")}">
                                    {include_ext file="common/icon.tpl" class="icon-shopping-cart"}
                                </a>
                            ...
                            {if $auth.company_id}
                                <li class="dropdown nav__company-name">
                                    <a href="{"companies.update?company_id=`$runtime.company_id`"|fn_url}">{__("vendor")}
                                        : {$runtime.company_data.company}</a>
                                </li>
                    ...
                    {if $auth.user_id && $navigation.static}
                        ...
                        {foreach from=$navigation.static.top key=first_level_title item=m name="first_level_top"}
                            <li class="dropdown dropdown-top-menu-item{if $first_level_title == $navigation.selected_tab} active{/if} navigate-items">
                                <a id="elm_menu_{$first_level_title}" href="{if $m.href}{$m.href|fn_url}{else}#{/if}"
                                   class="dropdown-toggle {$first_level_title}">
                                        ...
                                        {foreach from=$m.items key=second_level_title item="second_level" name="sec_level_top"}
                                            <li class="{if $second_level.subitems}dropdown-submenu{/if}{if $second_level_title == $navigation.subsection} active{/if} {if $second_level.is_promo}cm-promo-popup{/if} {$second_level.attrs.class}" {menu_attrs attrs=$second_level.attrs.main}>
                                                {if $second_level.type == "title"}
                                                    ...
                                                    {/if}
                                                    <a id="elm_menu_{$first_level_title}_{$second_level_title}"
                                                       class="{if $second_level.subitems}dropdown-submenu__link{/if} {if $second_level.attrs.class_href}{$second_level.attrs.class_href}{/if}" {menu_attrs attrs=$second_level.attrs.href}>
                                                ...
                                                {elseif $second_level.type != "divider"}
                                                    ...
                                                    {/if}
                                                    <a id="elm_menu_{$first_level_title}_{$second_level_title}"
                                                       class="{if $second_level.subitems}dropdown-submenu__link{/if} {if $second_level.attrs.class_href}{$second_level.attrs.class_href}{/if}"
                                                       href="{$second_level.href|fn_url}" {menu_attrs attrs=$second_level.attrs.href}>
                                                        {$second_level.title|default:__($second_level_title)}
                                                        {if $second_level.attrs.class === "is-addon"}{include_ext file="common/icon.tpl" class="icon-is-addon"}{/if}
                                                    </a>
                                                {/if}
                                                            ...
                                                            {if $sm.type != "divider"}
                                                                <li class="{if $sm.active}active{/if} {if $sm.is_promo}cm-promo-popup{/if} {$second_level.attrs.class}" {menu_attrs attrs=$sm.attrs.main}>
                                                                    ...
                                                                    {elseif $sm.type != "divider"}
                                                                        <a id="elm_menu_{$first_level_title}_{$second_level_title}_{$subitem_title}"
                                                                           {if $sm.attrs.class}class="{$sm.attrs.class}"{/if}
                                                                           href="{$sm.href|fn_url}" {menu_attrs attrs=$sm.attrs.href}>
                                                                            {$sm.title|default:__($subitem_title)}
                    ...
                    {if $auth.user_id}
                        ...
                        <li class="dropdown dropdown-top-menu-item dropdown--open-enable nav__user-menu{if $enable_onclick_menu} hover-show--disabled{/if}">
                            ...
                            <ul class="dropdown-menu pull-right nav__user-menu-dropdown">
                                ...
                                {/if}
                                    <li>
                                        <a href="{"profiles.update?user_id=`$auth.user_id`"|fn_url}">{__("edit_profile")}</a>
                                    </li>
                ...
                {hook name="index:global_search"}
                    <form id="global_search" method="get" action="{""|fn_url}" class="search__form">
                        ...
                        <label for="gs_text" class="search__group">
                            <input type="text"
                                   class="cm-autocomplete-off search__input {if $enable_search_collapse}search__input--collapse{/if}"
                                   id="gs_text" name="q" placeholder="{__("search")}" value="{$smarty.request.q}"/>
            ...
            <ul class="nav nav__menu hover-show nav-pills">
                        ...
                        <ul class="dropdown-menu menu-heading__dropdowned-menu">
                            ...
                            {if "ULTIMATE"|fn_allowed_for}
                                {if fn_check_view_permissions("companies.manage", "GET")}
                                    <li class="divider"></li>
                                    <li><a href="{"companies.manage?switch_company_id=0"|fn_url}">{__("manage_stores")}
                                            ...</a></li>
                                {/if}
                            {/if}
                                ...
                                "
                                    ...
                                    >
                                        ...
                                        "
                                                    {/if}
                                            >
                                                {if $second_level.subitems && !$navigation_accordion}
                                                    <div class="dropdown-submenu__link-overlay"></div>
                                                {/if}
                                            ...
                                            "
                                                ...
                                                >
                                                    ...
                                                    {if __($second_level.description) != "_`$second_level_title`_menu_description"}{if $settings.Appearance.show_menu_descriptions === "Y" && $show_menu_descriptions}
                                                        <span class="hint">{__($second_level.description)}</span>{/if}{/if}
                                                </a>
                                                ...
                                                "
                                                    ...
                                                    >
                                                        {foreach from=$second_level.subitems key=subitem_title item=sm}
                                                            <li class="{if $sm.active}active{/if} {if $sm.is_promo}cm-promo-popup{/if} {$second_level.attrs.class}" {menu_attrs attrs=$sm.attrs.main}>
                                                                <a href="{$sm.href|fn_url}" {menu_attrs attrs=$sm.attrs.href}>{$sm.title|default:__($subitem_title)}</a>
                                                            </li>
                                                        {/foreach}
                                                    </ul>
                                                {/if}
                ...
                {if $auth.user_id && $navigation.static.top}
                    ...
                    <ul class="nav hover-show nav-pills nav-child mobile-visible">
                        {foreach from=$navigation.static.top key=first_level_title item=m name="first_level_top"}
                            <li class="dropdown dropdown-top-menu-item{if $first_level_title == $navigation.selected_tab} active{/if} navigate-items">
                                <a id="elm_menu_{$first_level_title}" href="#"
                                   class="dropdown-toggle {$first_level_title}">
                                    {__($first_level_title)}
                                    <b class="caret"></b>
                                </a>
                                <ul class="dropdown-menu">
                                    {foreach from=$m.items key=second_level_title item="second_level" name="sec_level_top"}
                                        <li class="{if $second_level.subitems}dropdown-submenu{/if}{if $second_level_title == $navigation.subsection} active{/if} {if $second_level.is_promo}cm-promo-popup{/if} {$second_level.attrs.class}" {menu_attrs attrs=$second_level.attrs.main}>
                                            {if $second_level.type == "title"}
                                                <a id="elm_menu_{$first_level_title}_{$second_level_title}"
                                                   {if $second_level.attrs.class_href}class="{$second_level.attrs.class_href}"{/if} {menu_attrs attrs=$second_level.attrs.href}>{$second_level.title|default:__($second_level_title)}</a>
                                            {elseif $second_level.type != "divider"}
                                                <a id="elm_menu_{$first_level_title}_{$second_level_title}"
                                                   {if $second_level.attrs.class_href}class="{$second_level.attrs.class_href}"{/if}
                                                   href="{$second_level.href|fn_url}" {menu_attrs attrs=$second_level.attrs.href}>
                                                    {$second_level.title|default:__($second_level_title)}
                                                    {if $second_level.attrs.class === "is-addon"}{include_ext file="common/icon.tpl" class="icon-is-addon"}{/if}
                                                </a>
                                                ...
                                                <ul class="dropdown-menu">
                                                    {foreach from=$second_level.subitems key=subitem_title item=sm}
                                                        <li class="{if $sm.active}active{/if} {if $sm.is_promo}cm-promo-popup{/if} {$second_level.attrs.class}" {menu_attrs attrs=$sm.attrs.main}>
                                                            ...
                                                            {elseif $sm.type != "divider"}
                                                                <a id="elm_menu_{$first_level_title}_{$second_level_title}_{$subitem_title}"
                                                                   href="{$sm.href|fn_url}" {menu_attrs attrs=$sm.attrs.href}>{$sm.title|default:__($subitem_title)}</a>
                                                            {/if}
                                                        </li>
                                                        {if $sm.type == "divider"}
                                                            <li class="divider"></li>
