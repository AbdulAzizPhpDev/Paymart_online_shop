    ...
    <div class="ty-simple-list clearfix">
        ...
        {$smarty.capture.$form_open nofilter}
			...
			{hook name="products:product_rating"}
            	<div class="ty-simple-list__rating ut2-rating-stars {if $settings.abt__ut2.product_list.show_rating == "YesNo::YES"|enum && $addons.product_reviews.status == "ObjectStatuses::ACTIVE"|enum}r-block{/if}">
