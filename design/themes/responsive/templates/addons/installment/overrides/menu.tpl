                ...
                {hook name="index:global_search"}
                    <form id="global_search" method="get" action="{""|fn_url}" class="search__form">
                        ...
                        <label for="gs_text" class="search__group">
                            <input type="text" class="cm-autocomplete-off search__input {if $enable_search_collapse}search__input--collapse{/if}" id="gs_text" name="q" placeholder="{__("search")}" value="{$smarty.request.q}" />
